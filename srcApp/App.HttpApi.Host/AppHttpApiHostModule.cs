...
{
    [DependsOn(
        //typeof(AbpOcelot.OcelotGatewayHostModule),
        //typeof(Module1.Module1HttpApiClientModule),
        //typeof(Module2.Module2HttpApiClientModule),
    ...
    public class AppHttpApiHostModule : AbpModule
    {
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(options => { options.SwaggerEndpoint("/swagger/v1/swagger.json", "App API"); });
